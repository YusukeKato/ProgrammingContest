...
5分くらい考えて簡単だということに気づいた。
YesかNoを答えるだけだからたいしたことはない。
```
azzel
apple
```
...
### ABC-131:B
読解力が必要。
絶対値が一番小さいやつを探して、その値を総和から引く。

### ABC-131:C
最大公約数と最小公倍数を求められれば解ける問題。
以前と同じ失敗をした。
...
これだとlong long intを使っていてもオーバーフローする。
